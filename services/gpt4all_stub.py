...
app = Flask(__name__)
# Support directory + filename env vars; default to container-mounted /models
MODEL_DIR = os.getenv("GPT4ALL_MODEL_PATH", "/models")
MODEL_FILE = os.getenv("GPT4ALL_MODEL", "gpt4all.bin")
