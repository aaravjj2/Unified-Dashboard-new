...
(function() {
  ...
  function attachPasteListener() {
    ...
    if (!container) {
      console.log('[Paste] DataTable not found yet, will retry...');
      return;
    }
    ...
    console.log('[Paste] Paste listener attached to DataTable');
  }
  ...
  function handlePaste(e) {
    try {
      ...
      console.log('[Paste] Detected paste event, processing data...');
  ...
  function updateDataTable(parsedData) {
    try {
      ...
      console.log('[Paste] Parsed data:', parsedData);
      console.log('[Paste] Note: Full data update requires server-side callback implementation');
  ...
  console.log('[Paste] DataTable paste module loaded');
})();
