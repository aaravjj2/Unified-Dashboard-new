"""
Robust Playwright clicker for Market Trends 'run analysis' button.
Saves diagnostics on page errors and remains running until Ctrl+C.

Usage: python3 tools/clicker_long_run.py

Outputs saved under ./diagnostics
"""
...
with sync_playwright() as p:
    ...
    print('Starting robust click loop. Press Ctrl+C in this terminal to stop.')
    iteration = 0
    while keep_running:
        iteration += 1
        ...
        try:
            ...
            # Wait, but watch for page crashes via page.evaluate quick check
