...
def create_app():
    ...
    # ========================================================================
    # STEP 0: Start Chatbot Service (Auto-load AI model)
    # ========================================================================
    logger.info("Step 0: Starting chatbot service (auto-loading AI model)...")
    chatbot_available = start_chatbot_service()
    if chatbot_available:
        logger.info("✅ Chatbot service is available with AI model")
    else:
        logger.warning("⚠️ Chatbot service unavailable - using fallback mode")
