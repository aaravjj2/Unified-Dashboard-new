...
def register_callbacks(app):
    ...
    # ═══════════════════════════════════════════════════════════════════
    try:
        logger.info("🔧 Market Trends: Starting initialization...")
        ...
        logger.info("   ✅ Using internal callbacks only (external files disabled)")
        
        logger.info("🎉 Market Trends: Initialization COMPLETE!")
    except Exception as e:
        logger.error(f"❌ Market Trends initialization failed: {e}")
