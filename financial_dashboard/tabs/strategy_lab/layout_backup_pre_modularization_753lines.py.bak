...
Creates the main Strategy Lab layout with 3 primary sections:
1. Strategy Setup - Define trading rules and parameters
2. Backtest Execution - Run simulations on historical data
3. Results & Insights - Visualize performance and attribution
...
Remember: **Backtest performance ≠ Future performance**. Markets change, but good risk-adjusted returns with solid drawdown control usually persist better than pure high returns.
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.Div([
                                html.H6("CAGR", className="text-muted mb-1"),
                                html.H3(id='sl-metric-cagr', children="--", className="mb-0"),
                                html.Small("Annualized Return", className="text-muted")
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.Div([
                                ...
                                html.Small("% Profitable Trades", className="text-muted")
            ...
            dbc.Row([
                dbc.Col([
                    html.H6([
                        ...
                        html.I(className="bi bi-info-circle-fill text-muted", id="equity-curve-info", style={'fontSize': '0.9rem', 'cursor': 'pointer'})
            ...
            dbc.Row([
                dbc.Col([
                    html.H6([
                        ...
                        html.I(className="bi bi-info-circle-fill text-muted", id="benchmark-info", style={'fontSize': '0.9rem', 'cursor': 'pointer'})
                    ], className="fw-bold mb-2"),
                    dbc.Tooltip(
            ...
            dbc.Row([
                dbc.Col([
                    html.H6([
                        "Risk Exposure Breakdown ",
                        html.I(className="bi bi-info-circle-fill text-muted", id="exposure-info", style={'fontSize': '0.9rem', 'cursor': 'pointer'})
                    ], className="fw-bold mb-2"),
                    dbc.Tooltip(
                ...
                dbc.Col([
                    html.H6([
                        "Factor Attribution Analysis ",
                        html.I(className="bi bi-info-circle-fill text-muted", id="factor-info", style={'fontSize': '0.9rem', 'cursor': 'pointer'})
                    ], className="fw-bold mb-2"),
                    dbc.Tooltip(
...
def layout():
    """
    Creates the Strategy Lab main layout.
    
    Returns:
        dbc.Container: Complete Strategy Lab layout with all sections
    """
    logger.info("Creating Strategy Lab layout...")
...
3. **Analyze** - Deep-dive into returns, risk, and factor attribution
4. **Compare** - Benchmark against SPY and measure risk-adjusted performance

**💡 Quick Start:**
1. Choose a strategy type (start with Momentum)
2. Select tickers (or use Weekly Picks)
3. Define simple entry/exit rules
4. Run backtest and analyze results

**🎓 Learn More**: Each section includes detailed tooltips and explanations.
        ...
        # Section 1: Strategy Setup
        create_strategy_setup_section(),
        
        # Section 2: Backtest Execution
        create_backtest_section(),
