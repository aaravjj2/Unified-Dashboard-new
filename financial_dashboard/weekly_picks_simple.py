"""
Simple standalone Weekly Picks Dashboard
Displays the latest weekly picks CSV in a clean Dash table.
Run: python3 weekly_picks_simple.py
"""
...
app = Dash(__name__)
app.title = "Weekly Picks Dashboard"

def find_latest_weekly_csv():
    """Find the most recent weeklypicks CSV"""
    base_dir = os.path.dirname(__file__)
    patterns = [
        'models/weekly_run/weeklypicks*.csv',
        'models/weekly_run/picks*.csv',
...
def load_picks_data():
    ...
    try:
        ...
        display_cols = ['ticker', 'score', 'pred_rank', 'last_price', 'market_cap', 'volume']
...
if df is not None:
    ...
    layout_children = [
        html.H1("📊 Weekly Picks Dashboard", style={'color': '#e0e0e0'}),
...
if __name__ == '__main__':
    ...
    if df is not None:
        ...
        print(f"❌ {csv_info}")
    print("="*60)
    print("🌐 Starting server at http://0.0.0.0:8053")
    print("="*60)
