...
class GPT4AllValidator:
    ...
    def __init__(self, model_path: str | None = None,
        ...
        # Allow env var overrides; default to repo models dir + filename
        default_dir = os.getenv("GPT4ALL_MODEL_PATH", os.path.join(os.path.expanduser("~"), "Unified-Dashboard", "models"))
        default_file = os.getenv("GPT4ALL_MODEL", "gpt4all-falcon-newbpe-q4_0.gguf")
        self.model_path = model_path or os.path.join(default_dir, default_file)
