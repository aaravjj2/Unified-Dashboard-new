# BLOCKER REPORT: Load Options Chain

**Button ID:** ol-chain-load-btn  
**Tab:** options_lab  
...
❌ FAIL: Button #ol-chain-load-btn not found
...
1. Navigate to **options_lab** tab
2. Click **Load Options Chain** button
