...
Starts the dashboard server on port 8050.

Usage:
    python run_dashboard.py
    
Environment Variables:
    PORT: Override default port (default: 8050)
...
def main():
    """Run the dashboard server on port 8050."""
    ...
    if not check_port_available(host, port):
        ...
        logger.error(f"     PORT=8051 python run_dashboard.py")
        logger.error("")
        logger.error("=" * 60)
        sys.exit(1)
