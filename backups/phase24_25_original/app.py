...
def create_app():
    ...
    def _set_response_no_cache(response):
        """Mark ALL responses as no-cache to force fresh content."""
        try:
            # NUCLEAR OPTION: Disable ALL caching for ALL responses
...
try:
    ...
    # This forces DashProxy to process all @app.callback() decorators
